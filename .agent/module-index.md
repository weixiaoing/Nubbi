...
> 开发前读：`.agent/rules/core.md` → `.agent/skills/code.md` → `.agent/skills/style.md` → `docs/<module>/PRD.md`
> 审查时读：`agent.md`（根目录）→ `.agent/skills/review.md`
...
| `mcp/**` | knowledge-base | docs/knowledge-base/phase2-mcp-auth-PRD.md |
| `server/app/services/embedding/**` | knowledge-base | docs/knowledge-base/phase3-knowledge-base-PRD.md |
| `server/app/services/kb/**` | knowledge-base | docs/knowledge-base/phase3-knowledge-base-PRD.md |
| `server/app/services/ingestion/**` | knowledge-base | docs/knowledge-base/phase4-external-ingestion-PRD.md |
| `server/app/models/mcpToken.ts` | knowledge-base | docs/knowledge-base/phase2-mcp-auth-PRD.md |
| `server/app/models/noteEmbedding.ts` | knowledge-base | docs/knowledge-base/phase3-knowledge-base-PRD.md |
| `server/app/routes/mcpToken.ts` | knowledge-base | docs/knowledge-base/phase2-mcp-auth-PRD.md |
| `server/app/routes/kb.ts` | knowledge-base | docs/knowledge-base/phase3-knowledge-base-PRD.md |
| `client/src/views/settings/MCPTokenPanel.tsx` | knowledge-base | docs/knowledge-base/phase2-mcp-auth-PRD.md |
